    (function(){
        var access_token = document.getElementById('payment_mp_ticket_access_token');
    ...
    function loadPaymentMethods()
    {
        ...
        if (url_site.value != "")
        {
            ...
            url_backend += 'admin/index.php?route=extension/payment/mp_ticket/getPaymentMethods&user_token=' + token;
