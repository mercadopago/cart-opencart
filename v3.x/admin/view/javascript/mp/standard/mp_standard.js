(function() {
    ...
    country.onchange = function() {
        ...
        var user_token = window.location.href.split('user_token=')[1];
        if (url_site.value != '') {
            var url_backend = url_site.slice(-1) == '/' ? url_site : url_site + '/';
            var country = country_select.options[country_select.selectedIndex].value;
            url_backend += 'admin/index.php?route=extension/payment/mp_standard/get_payment_methods_by_country&country_id=' + country + '&user_token=' + user_token;
