	...
	protected function index() {
		...
		foreach ($this->cart->getProducts() as $product) {
    		$products .= $product['quantity'] . ' x ' . $product['name'] . ', ';
                ...
                $totalprice = $order_info['total'] * $order_info['value'];                   
...
Class Shop extends MercadoPago {
     ...
     public function GetMethods($country_id) {
      ...
      public function GetCheckout($data,$excludes){
            ...
            $header = array('Content-Type:application/json', 'User-Agent:MercadoPago OpenCart-1.4.9 Cart v1.0.1', 'Accept: application/json');
