...
<div class="col-sm-10">
<input type="hidden" value="<?php if(isset($mercadopago2_country)){echo $mercadopago2_country;} ;?>" id="countryName" />
...
<div class="form-group">
  <label class="col-sm-3 control-label" for="mercadopago2_order_status_id_completed"><?php echo $entry_order_status_general; ?></label>
</div>
<div class="form-group required">
...
<div class="form-group">
  <label class="col-sm-2 control-label" for="mercadopago2_order_status_chargeback">
  ...
  <div class="col-sm-10">
  <select class="form-control" name="mercadopago2_order_status_chargeback" id="mercadopago2_order_status_chargeback">
    <?php foreach ($order_statuses as $order_status) : ?>
                    <?php if (isset($mercadopago2_order_status_chargeback) && $order_status['order_status_id'] == $mercadopago2_order_status_chargeback) : ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php else : ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php endif; ?>
