...
class ControllerPaymentMercadopago2 extends Controller
{
    ...
    public function index() 
    {
        ...
        $fields = array('public_key', 'access_token', 'client_id', 'client_secret', 
                        'status', 'category_id', 'url', 'debug', 'sandbox', 'type_checkout', 
                        'country', 'installments', 'notification_url', 'order_status_id', 
    ...
    public function getPaymentMethodsByCountry()
    {
        ...
        error_log('meios de pagamento');
        error_log(json_encode($data['methods']));
