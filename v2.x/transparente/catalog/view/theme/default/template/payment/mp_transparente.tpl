            ...
            <div id="formulario" class="cartao">
                ...
                <div class="form-group" style="margin-bottom: 4%;" id="cardData">
                    ...
                    <div class="col-xs-10 col-md-3" style="margin-left: -2%; <?php echo $action == "MLB"? '':'margin-top: -4%' ?> ">
                        ...
                        <input class="form-control datepicker" type="text" id="expiration_month" data-checkout="cardExpirationMonth" placeholder="MM" maxlength="2" size="2" data-date-format="mm/dd/yyyy" />
                    </div>
                <?php endif;?>
