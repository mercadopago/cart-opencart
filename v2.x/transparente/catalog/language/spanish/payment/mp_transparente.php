...
$_['text_title'] = '<img src="' . $admin . 'view/image/payment/mp_transparente.png" alt="Mercado Pago" title="Mercado Pago" style="border: 1px solid #EEEEEE;"> - Tarjeta de Credito y Debito ';
