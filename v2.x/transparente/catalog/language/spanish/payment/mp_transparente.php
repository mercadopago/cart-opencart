...
$_['S5'] = 'Es necesario informar su token de acceso para continuar.';
...
$_['S2004'] = 'POST para la API de Gateway Transactions ha fracasado.';
$_['S2002'] = 'Customer no encontrado.';
$_['S2006'] = 'Card Token no encontrado.';
$_['S2007'] = 'Conexión con la API de Card Token ha fracasado.';
...
$_['S2018'] = 'La acción requisitada no es válida para el estado atual de pago.';
...
$_['S2024'] = 'pago fuera del período de reembolso.';
$_['S2025'] = 'Operation type no permitido para reembolso.';
$_['S2027'] = 'La acción requisitada es inválida para este tipo de pago.';
...
$_['S2060'] = "Vendedor y comprador no puedem ser el mismo usuário.";
$_['S3000'] = 'Rellena el campo "Nombre" igual a lo que está en su Tarjeta.';
$_['S3001'] = 'Debes enviar el cardissuer_id con los datos de su Tarjeta';
$_['S3003'] = 'card_token_id es inválido';
$_['S3004'] = 'site_id es inválido';
$_['S3005'] = 'Acción inválida, el recurso está en un estado que permite esta operación. Para obtener más información, vea el estado del recurso.';
$_['S3006'] = 'cardtoken_id inválido.';
$_['S3007'] = ' El parámetro client_id no puede ser nulo el vacio.';
$_['S3008'] = 'Cardtoken no encontrado.';
$_['S3009'] = 'client_id no autorizado.';
$_['S3010'] = 'Tarjeta no encontrade en la white list.';
$_['S3011'] = 'payment_method no encontrado.';
$_['S3012'] = 'security_code_length inválido.';
$_['S3013'] = 'El parámetro security_code es um campo obligatorio y no puede ser nulo el vacio.';
...
$_['S3017'] = 'El parámetro card_number_id no puede ser nulo el vacio.';
$_['S3018'] = 'El parámetro expiration_month no puede ser nulo el vacio.';
$_['S3019'] = 'El parámetro expiration_year no puede ser nulo el vacio.';
$_['S3020'] = 'El parámetro cardholder.name no puede ser nulo el vacio.';
$_['S3021'] = 'El parámetro cardholder.document.number no puede ser nulo el vacio.';
$_['S3022'] = 'El parámetro cardholder.document.type no puede ser nulo el vacio.';
$_['S3023'] = 'El parámetro cardholder.document.subtype no puede ser nulo el vacio.';
$_['S3024'] = 'Acción inválida - reembolso parcial no suportado para la transacción';
...
$_['S4022'] = "metadata debe ser um JSON válido.";
...
$_['S4039'] = "application_fee no puede ser um valor negativo.";
$_['S4050'] = "payer.email debe ser um email válido.";
$_['S4051'] = "payer.email debe tener menos que 254 caracteres.";

$_['T310'] = "Parámetro inválido:  'internal_client_id'";
$_['T200'] = "El parámetro 'public_key' debe tener um valor válido";
$_['T302'] = "Parámetro inválido:  'public_key'";
$_['T219'] = "El parámetro 'client_id' debe tener um valor válido";
$_['T315'] = "Parámetro inválido:  'site_id'";
$_['T222'] = "El parámetro 'site_id'é um campo obrigatório";
...
$_['T213'] = "El parámetro 'cardholder.identification.subtype' debe tener um valor válido";
...
$_['T301'] = "Data de expiração del tarjeta inválida";
$_['T317'] = "Parámetro inválido:  'card_id'";
$_['T320'] = "Parámetro inválido:  'luhn_validation'";
$_['TE111'] = "JSON inválido";
$_['TE114'] = "El parámetro cardholderName no puede ser nulo/vacio";
$_['TE115'] = "El parámetro public_key no puede ser nulo/vacio";
$_['TE202'] = "Parámetro inválido:  cardNumber";
$_['TE203'] = "Parámetro inválido:  securityCode";
$_['TE213'] = "Parámetro inválido:  card_present";
$_['TE301'] = "invalid length del parámetro cardNumber";
$_['TE302'] = "invalid length del parámetro securityCode";
$_['TE305'] = "invalid length del parámetro docType";
...
$_['S150'] = "Usted no puedes efectuar pagos.";
$_['S151'] = "Usted no puedes efectuarpagos.";
$_['S160'] = "No es posible procesar su pago.";
$_['S204'] = "Medio de pago indisponível. Escoja otra tarjeta.";
